                            ...
                            <div class="card-body">
                                ...
                                <div class="wizard">
                                    ...
                                    <div class="step active" id="step-1">
                                        <h2>1. Pilih Outlet</h2>
                                        <select id="outlet-select" style="width: 100%;"></select>
                                    </div>

                                    <!-- Step 2: Pilih Barang -->
                                    <div class="step" id="step-2">
                                        <h2>2. Pilih Barang</h2>
                                        <input type="text" id="item-search" placeholder="Cari barang..."
                                    ...
                                    <div class="step-buttons">
                                        <button id="prev-btn" disabled>Kembali</button>
                    ...
                    if (currentStep === 3) {
                        ...
                        $.ajax({
                            ...
                            contentType: 'application/json',
                              processData: false, // ini penting!
                            success: function(res) {
                                alert('Pengiriman berhasil disimpan!');
                                console.log(res);
                                // Reset wizard jika perlu
                            },
                            error: function(err) {
      ...
      <tr>
        ...
        <td>
          <input type="number" min="0" class="qty-input" 
                 data-id="${item.id}" style="width: 60px;" value="${item.qty}" />
        </td>
      </tr>
    `).join(''));
